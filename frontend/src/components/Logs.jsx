            ...
            <section>
                <header className="bg-white space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6">
                    <div className="flex items-center justify-between">
                        <h2 className="font-semibold text-slate-900">Journal Logs</h2>
                        <Link to='/logs/new'
                ...
                <ul className="bg-slate-50 p-4 sm:px-8 sm:pt-6 sm:pb-8 lg:p-4 xl:px-8 xl:pt-6 xl:pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4 text-sm leading-6">
                    {notes.map((note) => (
                        <li key={note._id} x-for="project in projects">
                            <a
                                href="logs/:note._id"
                                className="hover:bg-green-500 hover:ring-green-500 hover:shadow-md group rounded-md p-3 bg-white ring-1 ring-slate-200 shadow-sm"
                            >
